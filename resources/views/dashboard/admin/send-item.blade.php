            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('send-item-post') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Kode Item</label>
                                    <input type="text" class="form-control" id="exampleInput1" placeholder="Kode Item"
                                        name="item_code">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Stack</label>
                                    <input type="text" class="form-control" id="stack" placeholder="Stack"
                                        name="stack">
                                </div>
                            </div>
                            <!-- /.card-body -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                ...
                                                <label for="customCheckbox5" class="custom-control-label">Custom Checkbox
                                                    with custom color outline</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
